...
public class TestClientProtocolForPipelineRecovery {
  ...
  public void testPacketTransmissionDelay() throws Exception {
    ...
    try {
      ...
      LOG.info("Failure Recovery, the length of the nodes are"+newNodes.length);
...
//      System.out.println("Memory Usage: " + memoryUsage + "%");
  ...
  public void testShadowExecutionRule1() throws Exception {
    ...
    try {
      ...
      dfsOut.shadowStreamer.close(true);
  ...
  @Test
  public void testShadowExecutionRule2() throws Exception {
    // Make the first datanode to not relay heartbeat packet.
    DataNodeFaultInjector oldDnInjector = DataNodeFaultInjector.get();
  ...
  @Test
  public void testShadowExecutionRule3() throws Exception {
    // Make the first datanode to not relay heartbeat packet.
    DataNodeFaultInjector oldDnInjector = DataNodeFaultInjector.get();
    ...
    try {
      ...
      // new pipeline
      DatanodeInfo[] newNodes = dfsOut.shadowStreamer.getNodes();
